...
<body>
    <article style="background-image: url(https://petnow.com.vn/wp-content/uploads/2023/08/bg-featured-title.jpg);">
        <div class="overlay-text">
            <h1><b>Giống Mèo</b></h1>
            <p><a href="index.php">HOME</a> / Giống Mèo</p>
        </div>
    </article>
    <main>
        <div class="main">
                ...
                <div class="filter-section">
                    ...
                    <form id="filter-form" method="post" action="">
                        <div class="price-range">
                            ...
                            <input type="hidden" name="start_gia" value="500000" />
                        </div>
                        <div class="categories-section">
                            <h4>Loại mèo</h4>
                            <select name="giong">
                                <option value="">Tất cả</option>
                                <option value="Mèo Anh lông ngắn" <?php echo (isset($giongthucung) && $giongthucung === 'Mèo Anh lông ngắn') ? 'selected' : ''; ?>>Mèo Anh lông ngắn</option>
                                <option value="Mèo Anh lông dài" <?php echo (isset($giongthucung) && $giongthucung === 'Mèo Anh lông dài') ? 'selected' : ''; ?>>Mèo Anh lông dài</option>
                                <option value="Mèo Bengal" <?php echo (isset($giongthucung) && $giongthucung === 'Mèo Bengal') ? 'selected' : ''; ?>>Mèo Bengal</option>
                                <option value="Mèo Munchkin" <?php echo (isset($giongthucung) && $giongthucung === 'Mèo Munchkin') ? 'selected' : ''; ?>>Mèo Munchkin</option>
                            </select>
                        </div>
                        <div class="filter-button">
                            <button type="button" onclick="applyFilter()">LỌC</button>
                        </div>
                    </form>
                </div>
            </div>
